...
-- Master Script - Run this to create the entire gold layer
...
SELECT 'Fact table created' as status;
...
SELECT 'Power BI view created' as status;
...
UNION ALL
SELECT 'fact_service_requests' as table_name, COUNT(*) as record_count FROM ${VAR.gold_catalog}.${VAR.schema_name}.fact_service_requests;
...
SELECT 
    ...
    SUM(resolved_same_day) as same_day_resolutions,
...
SELECT 
    '🎉 SUCCESS: NYC 311 Gold Layer Complete!' as message,
    current_timestamp() as completion_time,
    '${VAR.gold_catalog}.${VAR.schema_name}' as schema_location,
    'vw_service_requests_powerbi' as powerbi_view,
    'Ready for analytics and Power BI!' as next_steps;
